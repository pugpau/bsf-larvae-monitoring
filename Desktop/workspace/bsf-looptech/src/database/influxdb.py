...
class InfluxDBClient:
    ...
    def write_point(self, point):
        ...
        Args:
            point: Dictionary containing the data point with measurement, tags, fields, and time.
        ...
        try:
            ...
            logger.error(f"InfluxDB error writing point: {e}")
            return False
        except Exception as e:
            logger.error(f"Unexpected error writing point: {e}")
            return False
    ...
    def query(self, query_string):
        ...
        try:
            ...
            return self.query_api.query(query=query_string, org=self.org)
        except InfluxDBError as e:
